...
import hagwonsData from '@/data/hagwons';
import ibsolution from '@/data/ibsolution';
import FilterLinksClient from '@/app/hagwons/FilterLogic.client';

const allHagwonsData = [ibsolution, ...hagwonsData];
...
export default function IBSolutionMockupPage() {
  return (
    <main className="min-h-screen max-w-4xl mx-[5dvw] lg:mx-auto mb-[10em]">
      ...
      <article>
        ...
        <p className="mt-1 text-gray-400 text-sm">지난달 조회수: {process.env.NEXT_PUBLIC_HAGWONS_MONTHLY_VIEWS || '0'}회</p>
