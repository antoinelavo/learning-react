  ...
  return (
    <main className="min-h-screen bg-gray-50 py-16 px-4">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-md">
        <h1 className="text-center">개인정보처리방침</h1>
        <p>
            <br></br><br></br>
            <strong>제1조(목적)</strong>
            <br></br><br></br>
             IB Master(이하 ‘회사’라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 ‘정보통신망법’) 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
            ...
            회사는 제2항의 공지는 본 방침 개정의 시행일로부터 최소 7일 이전에 공지합니다.
             다만, 이용자 권리에 중요한 변경이 있을 경우에는 최소 30일 전에 공지합니다.
            ...
            <br></br><br></br>
            <strong>제6조(결제 서비스를 위한 정보)</strong>
            <br></br><br></br>        
            ...
            <br></br><br></br>
            <strong>제11조(사전동의 등에 따른 개인정보의 제공)</strong>
            <br></br><br></br>
            회사는 개인정보를 제3자 제공 금지에도 불구하고, 이용자가 사전에 공개하거나 다음 각호 사항에 대하여 동의한 경우에는 제3자에게 개인정보를 제공할 수 있습니다. 다만 이 경우에도 회사는 관련 법령 내에서 최소한으로 개인정보를 제공합니다.
             가. 웹사이트 사용자에게 서비스 이용을 위하여 이름, 경력, 및 성생님 관련 정보를 공개하는 경우
            회사는 전항의 제3자 제공 관계에 변화가 있거나 제3자 제공 관계가 종결될 때도 같은 절차에 의해 이용자에게 고지 및 동의를 구합니다.
            
            <br></br><br></br>
            <strong>제12조(개인정보의 보유 및 이용기간)</strong>
            <br></br><br></br>
            ...
            <br></br><br></br>
            <strong>제13조(법령에 따른 개인정보의 보유 및 이용기간)</strong>
            <br></br><br></br>
            ...
            회사는 파기 사유가 발생한 개인정보를 개인정보보호 책임자와 승인절차를 거쳐 파기합니다.
            
            <br></br><br></br>
            <strong>제16조(개인정보파기방법)</strong>
            <br></br><br></br>
             회사는 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제하며, 종이로 출력된 개인정보는 분쇄기로 분쇄하거나 소각 등을 통하여 파기합니다.
            
            <br></br><br></br>
            <strong>제17조(광고성 정보의 전송 조치)</strong>
            <br></br><br></br>
            회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 이용자의 명시적인 사전동의를 받습니다. 다만, 다음 각호 어느 하나에 해당하는 경우에는 사전 동의를 받지 않습니다.
             ...
             나. 「방문판매 등에 관한 법률」에 따른 전화권유판매자가 육성으로 수신자에게 거래에 대한 목적임을 고지하고 전화권유를 하는 경우
            회사는 전항에도 불구하고 수신자가 수신거부의사를 표시하거나 사전 동의를 철회한 경우에는 영리목적의 광고성 정보를 전송하지 않으며 수신거부 및 수신동의 철회의 처리 결과를 알립니다.
            ...
            <br></br><br></br>
            <strong>제19조(개인정보 조회 및 수집동의 철회)</strong>
            <br></br><br></br>
            ...
            <br></br><br></br>
            <strong>제20조(개인정보 정보변경 등)</strong>
            <br></br><br></br>
            이용자는 회사에게 전조의 방법을 통해 개인정보의 오류에 대한 정정을 요청할 수 있습니다.
            회사는 전항의 경우에 개인정보의 정정을 완료하기 전까지 전자가 개인정보를 이용 또는 제공하지 않으며 잘못된 개인정보를 제3자에게 이미 제공한 경우에는 정정 처리결과를 제3자에게 지체 없이 통지하여 정정이 이루어지도록 하겠습니다.
            
            <br></br><br></br>
            <strong>제21조(이용자의 의무)</strong>
            <br></br><br></br>
            이용자는 자신의 개인정보를 최신의 상태로 유지해야 하며, 이용자의 부정확한 정보 입력으로 발생하는 문제의 책임은 이용자 자신에게 있습니다.
            타인의 개인정보를 도용한 회원가입의 경우 이용자 자격을 상실하거나 관련 개인정보 보호 법령에 의해 처벌받을 수 있습니다.
            이용자는 전자우편주소, 비밀번호 등에 대한 보안을 유지할 책임이 있으며 제3자에게 이를 양도하거나 대여할 수 없습니다.
            
            <br></br><br></br>
            <strong>제22조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</strong>
            <br></br><br></br>
            회사는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용 정보를 저장하고 수시로 불러오는 개인정보 자동 수집장치(이하 '쿠키')를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 웹브라우저(PC 및 모바일을 포함)에 보내는 소량의 정보이며 이용자의 저장공간에 저장되기도 합니다.
            이용자는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서 이용자는 웹브라우저에서 옵션을 설정함으로써 모든 쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 아니면 모든 쿠키의 저장을 거부할 수도 있습니다.
            다만, 쿠키의 저장을 거부할 경우에는 로그인이 필요한 회사의 일부 서비스는 이용에 어려움이 있을 수 있습니다.
            
            <br></br><br></br>
            <strong>제23조(쿠키 설치 허용 지정 방법)</strong>
            <br></br><br></br>
            ...
            <br></br><br></br>
            <strong>제24조(회사의 개인정보 보호 책임자 지정)</strong>
            <br></br><br></br>
