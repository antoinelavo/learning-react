export default function HagwonCard({
  image,
  name,
  region,
  format,
  ...
  return (
    <div className="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
      ...
      <details className="mt-[1em] border-t pt-4 text-gray-600 w-full group">
        <summary className="cursor-pointer font-semibold text-sm text-gray-700 py-2 hover:underline">
          더보기 / 접기
        </summary>
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          <a
            ...
            className="contact-btn px-4 py-2 text-sm bg-gray-50 border border-gray-300 rounded-lg text-gray-900 hover:bg-gray-100 hover:border-gray-400"
          >
            홈페이지
          </a>
        </div>
