const satHagwons = [
  ...
  // {
  //   image: "/images/hagwons/small/triple.png",
  ...
  {
    image: "/images/hagwons/small/thei.png",
    name: '디아이 (The I Prep)',
    region: '서울 강남',
    lessonType: ['그룹'],
    format: ['대면'],
  ...
  {
    image: "/images/hagwons/small/nobelprep.png",
  ...
  {
    image: "/images/hagwons/small/prima.png",
    name: 'PRIMA (프리마 어학원)',
    region: '성남 분당',
    lessonType: ['그룹', '1:1'],
    format: ['대면'],
  ...
  {
    image: "/images/hagwons/small/masterprep.png",
    name: 'MasterPrep (인강)',
    region: '온라인',
    lessonType: ['인강'],
    format: ['온라인'],
    services: [],
    url: "https://www.masterprep.net/",
    kakaotalk: ""
